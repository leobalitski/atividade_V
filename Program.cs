    ...
    public class Program : System.Windows.Forms.Form
    {
        ...
        public class Formulario : Form
        {
            ...
            public Formulario ()
            {
                ...
                this.BackColor = ColorTranslator.FromHtml("#483D8B");

                // Imagem do senac 
                pb_Imagem = new PictureBox();
                pb_Imagem.Location = new Point (10, 10);    
                pb_Imagem.Size = new Size(500 , 150);
                ...
                rtxt_Nome.SelectionFont = new Font("Verdana", 10, FontStyle.Bold);  
                ...
                chk_Email.Text = "nova Via E-mail"; 
                ...
                chk_WhatsApp.Text = "nova Via WhatsApp"; 
